...
test('cpu stack pointer should point to end of memory after start', () => {
    expect(cpu.registers.getValueByName(REGISTERS.SP.name)).toBe(cpu.stackPointerInitial);
});
...
test('cpu should execute instruction MOVE LITERAL TO REGISTER', () => {
    ...
    memory.byteAt[3] = REGISTERS.R1.address;

    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0000');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0x0000');
    
    cpu.tick();
    
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0004');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0xABCD');
});
...
test('cpu should execute instruction MOVE REGISTER TO REGISTER', () => {
    ...
    memory.byteAt[5] = REGISTERS.R1.address;
    memory.byteAt[6] = REGISTERS.R2.address;

    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0000');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0x0000');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R2.name))).toEqual('0x0000');
    ...
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0007');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0xABCD');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R2.name))).toEqual('0xABCD');
});
...
test('cpu should execute instruction MOVE REGISTER TO MEMORY', () => {
    ...
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0008');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0xABCD');
...
test('cpu should execute instruction MOVE MEMORY TO REGISTER', () => {
    ...
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0004');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0x2345');
    expect(format.asWord(memory.getUint16(0x0004))).toEqual('0x2345');
...
test('cpu should execute instruction ADD REGISTER TO REGISTER', () => {
    ...
    memory.byteAt[7] = REGISTERS.R2.address;

    memory.byteAt[8] = INSTRUCTIONS.ADD_REG_REG.opcode;
    memory.byteAt[9] = REGISTERS.R1.address;
    memory.byteAt[10] = REGISTERS.R2.address;

    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0000');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0x0000');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R2.name))).toEqual('0x0000');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.ACC.name))).toEqual('0x0000');

    cpu.tick();

    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0004');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0x0204');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R2.name))).toEqual('0x0000');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.ACC.name))).toEqual('0x0000');
    ...
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0008');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0x0204');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R2.name))).toEqual('0x0306');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.ACC.name))).toEqual('0x0000');
    
    cpu.tick();

    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x000B');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0x0204');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R2.name))).toEqual('0x0306');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.ACC.name))).toEqual('0x050A');
});
...
test('cpu should execute instruction SUBTRACT REGISTER TO REGISTER', () => {
    ...
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0004');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0x0306');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R2.name))).toEqual('0x0000');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.ACC.name))).toEqual('0x0000');
    ...
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0008');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0x0306');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R2.name))).toEqual('0x0102');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.ACC.name))).toEqual('0x0000');
    ...
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0x0306');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R2.name))).toEqual('0x0102');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.ACC.name))).toEqual('0x0204');
});
...
test('cpu should execute instruction JUMP EQUAL', () => {
    ...
    memory.byteAt[3] = REGISTERS.ACC.address;
    ...
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0004');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.ACC.name))).toEqual('0x1234');
    
    cpu.tick();

    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x001F');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.ACC.name))).toEqual('0x1234');
});
...
test('cpu should execute instruction PUSH LITERAL TO STACK', () => {
    ...
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0000');
    expect(cpu.registers.getValueByName(REGISTERS.SP.name)).toEqual(cpu.stackPointerInitial);
    expect(format.asWord(cpu.memory.getUint16(cpu.registers.getValueByName(REGISTERS.SP.name)))).toEqual('0x0000');
    
    cpu.tick();

    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0003');
    expect(cpu.registers.getValueByName(REGISTERS.SP.name)).toEqual(cpu.stackPointerInitial - 2);
    expect(format.asWord(cpu.memory.getUint16(cpu.registers.getValueByName(REGISTERS.SP.name) + 2))).toEqual('0x1234');
});
...
test('cpu should execute instruction PUSH REGISTER TO STACK', () => {
    ...
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0004');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0x1234');
    expect(cpu.registers.getValueByName(REGISTERS.SP.name)).toEqual(cpu.stackPointerInitial);
    expect(format.asWord(cpu.memory.getUint16(cpu.registers.getValueByName(REGISTERS.SP.name)))).toEqual('0x0000');

    cpu.tick();

    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0006');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0x1234');
    expect(cpu.registers.getValueByName(REGISTERS.SP.name)).toEqual(cpu.stackPointerInitial - 2);
    expect(format.asWord(cpu.memory.getUint16(cpu.registers.getValueByName(REGISTERS.SP.name) + 2))).toEqual('0x1234');
});
...
test('cpu should execute instruction POP FROM STACK', () => {
    ...
    memory.byteAt[4] = REGISTERS.R1.address;
    ...
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.IP.name))).toEqual('0x0005');
    expect(format.asWord(cpu.registers.getValueByName(REGISTERS.R1.name))).toEqual('0x1234');
    expect(cpu.registers.getValueByName(REGISTERS.SP.name)).toEqual(cpu.stackPointerInitial);
});
