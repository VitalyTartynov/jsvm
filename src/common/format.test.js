...
describe('Format function', () => {
  ...
  test('should throw error for format negative value as byte', () => {
  ...
  test('should throw error for format negative value as word', () => {
    // eslint-disable-next-line require-jsdoc
  ...
  test('should throw error for format negative value as dword', () => {
    // eslint-disable-next-line require-jsdoc
    function formatNegativeWord() {
      format.asDword(-1);
    }
  ...
  test('should throw error for format negative value as qword', () => {
    // eslint-disable-next-line require-jsdoc
    function formatNegativeWord() {
      format.asQword(-1);
    }
